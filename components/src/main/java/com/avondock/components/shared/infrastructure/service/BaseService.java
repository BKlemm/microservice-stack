package com.avondock.components.shared.infrastructure.service;

import com.avondock.components.common.http.ElasticRestClient;
import com.avondock.components.common.http.WebClientAdapter;
import com.avondock.components.shared.domain.contracts.Entity;
...
public abstract class BaseService<T extends Entity, ID, R extends CrudRepository<T, ID>> {
     ...
     *
     * @param apql filter query language
     */
